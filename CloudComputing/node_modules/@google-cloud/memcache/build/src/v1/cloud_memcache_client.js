...
class CloudMemcacheClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1.OperationMetadata');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1.OperationMetadata');
        const updateParametersResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1.Instance');
        const updateParametersMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1.OperationMetadata');
        const applyParametersResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1.Instance');
        const applyParametersMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1.OperationMetadata');
        const rescheduleMaintenanceResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1.Instance');
        const rescheduleMaintenanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.memcache.v1.CloudMemcache', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.cloudMemcacheStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.memcache.v1.CloudMemcache')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.memcache.v1.CloudMemcache, this._opts, this._providedCustomServicePath);
