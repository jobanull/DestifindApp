...
exports.CloudMemcacheClient = void 0;
 ...
 */
const gapicConfig = require("./cloud_memcache_client_config.json");
...
class CloudMemcacheClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listInstances: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'resources'),
        };
        ...
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.OperationMetadata');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.OperationMetadata');
        const updateParametersResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.Instance');
        const updateParametersMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.OperationMetadata');
        const applyParametersResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.Instance');
        const applyParametersMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.OperationMetadata');
        const applySoftwareUpdateResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.Instance');
        const applySoftwareUpdateMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.OperationMetadata');
        const rescheduleMaintenanceResponse = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.Instance');
        const rescheduleMaintenanceMetadata = protoFilesRoot.lookup('.google.cloud.memcache.v1beta2.OperationMetadata');
        this.descriptors.longrunning = {
            ...
            updateParameters: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateParametersResponse.decode.bind(updateParametersResponse), updateParametersMetadata.decode.bind(updateParametersMetadata)),
            ...
            applyParameters: new this._gaxModule.LongrunningDescriptor(this.operationsClient, applyParametersResponse.decode.bind(applyParametersResponse), applyParametersMetadata.decode.bind(applyParametersMetadata)),
            applySoftwareUpdate: new this._gaxModule.LongrunningDescriptor(this.operationsClient, applySoftwareUpdateResponse.decode.bind(applySoftwareUpdateResponse), applySoftwareUpdateMetadata.decode.bind(applySoftwareUpdateMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.memcache.v1beta2.CloudMemcache', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.cloudMemcacheStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.memcache.v1beta2.CloudMemcache')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.memcache.v1beta2.CloudMemcache, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of cloudMemcacheStubMethods) {
            const callPromise = this.cloudMemcacheStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    updateInstance(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'resource.name': (_a = request.resource.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    updateParameters(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkUpdateParametersProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    applyParameters(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkApplyParametersProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    applySoftwareUpdate(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                instance: (_a = request.instance) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkApplySoftwareUpdateProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
...
exports.CloudMemcacheClient = CloudMemcacheClient;
//# sourceMappingURL=cloud_memcache_client.js.map